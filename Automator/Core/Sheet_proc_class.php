...
//To Use Todays Date $G_End_Date=date("Y-m-d ");
...
if ($G_End_Date_checker == '6') {
    $obj = new Sheet_proc($argv[2],$argv[3],$argv[4],$argv[5],$argv[6],$argv[7]);
    $queryString=$obj->file_processor($argv[1]);
