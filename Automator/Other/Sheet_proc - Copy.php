...
[2]---->File To Write (Only name  Without Extension)
[3]---->Semester (Only Number)
[4]---->Division
[5]---->Subject Code
-----------------------------*/
...
/* echo $file; */
$file_op = fopen($st, "w");
$query_string = "INSERT INTO `db_testing`.`att_testing_struct` (`Lacture_Date`,`Subject_Code`, `Sr no`, `Erol`, `DepartmentID`, `Semester`, `DivisionID`, `BatchID`, `Present`,`SDLN`) VALUES";
...
/*  $spreadsheet_url="https://docs.google.com/spreadsheets/d/1rkrIJgr-ZmMlZEp7Xp47U87KGy12w1l_tLkiJNjeLxw/pub?output=csv";
