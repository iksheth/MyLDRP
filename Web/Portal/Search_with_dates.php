...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Class Attendance search [Semester Division And Dates] </h5>
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="btn-group btn-input clearfix k_dropdown">
                                <span class="label label-info fzull-width">semester</span>
                                <button type="button" class="btn btn-default dropdown-toggle form-control"
                                        data-toggle="dropdown">
                                    <span id="semester" data-bind="label">Semester</span>&nbsp;<span class="caret"></span>
                                </button>
                                <ul class="dropdown-menu" role="menu" id="Sem_number_data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="btn-group btn-input clearfix k_dropdown">
                                <span class="label label-warning" >Division</span>
                                <button type="button" class="btn btn-default dropdown-toggle form-control"
                                        data-toggle="dropdown">
                                    <span id='div' data-bind="label">Division</span>&nbsp;<span class="caret"></span>
                                </button>
                                <ul class="dropdown-menu" role="menu" id="div_data">
                                    <li><a href="#">Item 1</a></li>
                                    <li><a href="#">Another item</a></li>
                                    <li><a href="#">This is a longer item that will not fit properly</a></li>
                                </ul>
                    ...
                    <div class="row">
                        ...
                        <button id="d_search_btn" type="button" class="btn btn-primary block pull-right"
    ...
    <div class="row" id="inline-form-container" style="visibility: hidden">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
...
<script>
    ...
    function show_semester() {
        ...
        $.ajax({
            type: "post",
            url: "ajax_snippates/semester_list.php",
            data: null,
//             contentType: "application/json; charset=utf-8",
            ...
            success: function (response) {
                for (var i in response) {
                    data_string = data_string + "<li><a href='#'>" + response[i] + "</a></li>";
                    console.log(response);
                }
                $("#Sem_number_data").html(data_string);
    ...
    function show_divisions() {
        ...
        $.ajax({
            type: "post",
            url: "ajax_snippates/division_list.php",
            data: null,
//             contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: true,
    ...
    function search_with_dates() {
            var semester = $('#semester').text();
            var division = $('#div').text();
            var start_date = $('#start_date').val();
            var end_date = $('#end_date').val();
        var myKeyVals = {semester: semester,division: division,start_date: start_date,end_date: end_date};

        $.ajax({
            type: "post",
            url: "ajax_snippates/search_with_dates.php",
            data: myKeyVals,
//             contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: true,
            cache: false,
            success: function (response) {
                console.log(response['number_of_subjects']);

                console.log(response['data']);


                    head_top = "<div class='col-lg-12'> <div class='ibox float-e-margins'> <div class='ibox-title'> <h5>Attendance of <a id='place_erol' onclick='' href='javascript:void(0);' class='' >ABC</a></h5> <div class='ibox-tools'> <a class='collapse-link'> <i class='fa fa-chevron-up'></i> </a> <a class='dropdown-toggle' data-toggle='dropdown' href='#'> <i class='fa fa-wrench'></i> </a> <ul class='dropdown-menu dropdown-user'> <li><a href='#'>Config option 1</a> </li> <li><a href='#'>Config option 2</a> </li> </ul> <a class='close-link'> <i class='fa fa-times'></i> </a> </div> </div> <div class='ibox-content'>  <div class='table-responsive'> <table class='table table-striped table-bordered table-hover dataTables-example'> <thead><tr>"
                    head_mid = "<th>Enrollment Number</th>";

                    $.each(response['subject_name'], function(key, value){
                        head_mid = head_mid+" <th>"+value+"</th>";

                    });
                   /* for (i = 0; i <= response['number_of_subjects']; i++) {
                        head_mid = head_mid+" <th>"+response['data'][i]+"</th>"
                    }*/
                    head_end = "</tr></thead> <tbody id='inline_form_data_body'>"
                    head = head_top+head_mid+head_end;
                    mid = "";
                ...
                if(response['data']!=null) {
                    ...
                    $.each(response['data'], function(key, value){
                        ...
                        $.each(value, function(key, value){
                            mid=mid+"<td class='text-center'>"+value+"</td>";
                    ...
                    $("#inline-form-container").html(head + mid).css('visibility', 'visible');
                    rander_table();
    ...
    function rander_table() {
        ...
        $('.dataTables-example').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'pdf',
                    title: "Attendance Of Semester: "+semester+" Division: "+division,
                    orientation: 'portrait',
                    pageSize: 'A4',
                    message:"Date from: "+start_date+",  Date to: "+end_date,
                    filename: 'MyLDRP',
                    filename:"Attendance Of Semester "+semester+" Division "+division+" ("+start_date+" to "+end_date+")",
                    customize: function (doc) {

                        var cols = [];
                        cols[0] = {text: 'Computer Engineering', alignment: 'left', margin: [20]};
                        cols[1] = {text: 'LDRP-ITR,KSV,Gandhinagar', alignment: 'right', margin: [0, 0, 20]};
                        var objFooter = {};
